...
wire   [5:0] phitmp_cast_fu_156_p3;
...
assign icmp_ln508_fu_108_p2 = ((t_reg_75 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_127_p2 = ((i_1_fu_121_p2 == 32'd4) ? 1'b1 : 1'b0);
...
assign t_1_fu_102_p2 = (t_reg_75 + 9'd1);

assign tmp_fu_146_p4 = {{r_reg_86[5:2]}};
