...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_14_StreamingDataWidthConverter_Batch_14,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.134000,HLS_SYN_LAT=32771,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=569,HLS_SYN_LUT=197,HLS_VERSION=2020_2}" *)

module StreamingDataWidthConverter_Batch_14 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
wire   [3:0] ei_V_fu_117_p1;
reg   [3:0] ei_V_reg_179;
wire   [0:0] icmp_ln517_fu_127_p2;
wire   [507:0] phitmp_cast_fu_156_p3;
...
StreamingDataWidthConverter_Batch_14_regslice_both #(
    .DataWidth( 8 ))
...
assign ei_V_fu_117_p1 = in0_V_TDATA_int_regslice[3:0];

assign i_1_fu_121_p2 = (i_fu_58 + 32'd1);

assign icmp_ln508_fu_108_p2 = ((t_reg_75 == 16'd32768) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_127_p2 = ((i_1_fu_121_p2 == 32'd128) ? 1'b1 : 1'b0);
...
assign tmp_fu_146_p4 = {{r_reg_86[507:4]}};

endmodule //StreamingDataWidthConverter_Batch_14
