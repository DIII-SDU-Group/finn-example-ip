...
(* CORE_GENERATION_INFO="FMPadding_Batch_6_FMPadding_Batch_6,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.731500,HLS_SYN_LAT=9219,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=50,HLS_SYN_LUT=365,HLS_VERSION=2020_2}" *)

module FMPadding_Batch_6 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
reg   [13:0] indvar_flatten19_reg_83;
reg   [2:0] y_reg_94;
reg   [11:0] indvar_flatten_reg_105;
reg   [2:0] x_reg_116;
reg   [8:0] simd_reg_127;
wire   [13:0] add_ln279_fu_149_p2;
...
wire   [2:0] select_ln279_2_fu_273_p3;
wire   [2:0] select_ln280_1_fu_319_p3;
wire   [0:0] tmp_fu_327_p1;
wire   [8:0] simd_1_fu_343_p3;
wire   [11:0] select_ln280_2_fu_357_p3;
wire    ap_CS_fsm_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
wire   [0:0] ap_phi_reg_pp0_iter0_outData_1_reg_138;
reg   [0:0] ap_phi_reg_pp0_iter1_outData_1_reg_138;
...
wire   [2:0] add_ln279_1_fu_217_p2;
...
wire   [2:0] select_ln279_fu_209_p3;
wire   [2:0] x_2_fu_281_p2;
...
wire   [8:0] add_ln281_fu_331_p2;
wire   [11:0] add_ln280_1_fu_351_p2;
reg   [2:0] ap_NS_fsm;
...
FMPadding_Batch_6_regslice_both #(
    .DataWidth( 8 ))
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_94)) begin
        if (((select_ln280_fu_311_p3 == 1'd1) & (icmp_ln279_fu_197_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_outData_1_reg_138 <= 1'd0;
...
assign add_ln279_1_fu_217_p2 = (y_reg_94 + 3'd1);

assign add_ln279_fu_149_p2 = (indvar_flatten19_reg_83 + 14'd1);

assign add_ln280_1_fu_351_p2 = (indvar_flatten_reg_105 + 12'd1);

assign add_ln281_fu_331_p2 = (simd_reg_127 + 9'd1);
...
assign cmp3_i_i_fu_155_p2 = ((y_reg_94 == 3'd0) ? 1'b1 : 1'b0);

assign cmp3_i_i_mid1_fu_223_p2 = ((add_ln279_1_fu_217_p2 == 3'd0) ? 1'b1 : 1'b0);

assign cmp4_i_i_fu_161_p2 = ((y_reg_94 > 3'd4) ? 1'b1 : 1'b0);

assign cmp4_i_i_mid1_fu_229_p2 = ((add_ln279_1_fu_217_p2 > 3'd4) ? 1'b1 : 1'b0);

assign cmp5_i_i_fu_173_p2 = ((x_reg_116 == 3'd0) ? 1'b1 : 1'b0);

assign cmp5_i_i_mid1_fu_287_p2 = ((x_2_fu_281_p2 == 3'd0) ? 1'b1 : 1'b0);

assign cmp6_i_i_fu_179_p2 = ((x_reg_116 > 3'd4) ? 1'b1 : 1'b0);

assign cmp6_i_i_mid1_fu_293_p2 = ((x_2_fu_281_p2 > 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln279_fu_197_p2 = ((indvar_flatten19_reg_83 == 14'd9216) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_203_p2 = ((indvar_flatten_reg_105 == 12'd1536) ? 1'b1 : 1'b0);

assign icmp_ln281_fu_261_p2 = ((simd_reg_127 == 9'd256) ? 1'b1 : 1'b0);
...
assign select_ln279_fu_209_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 3'd0 : x_reg_116);

assign select_ln280_1_fu_319_p3 = ((and_ln279_fu_267_p2[0:0] == 1'b1) ? x_2_fu_281_p2 : select_ln279_fu_209_p3);

assign select_ln280_2_fu_357_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 12'd1 : add_ln280_1_fu_351_p2);

assign select_ln280_fu_311_p3 = ((and_ln279_fu_267_p2[0:0] == 1'b1) ? or_cond_i_i_mid1_fu_305_p2 : or_ln279_fu_249_p2);

assign simd_1_fu_343_p3 = ((or_ln281_fu_337_p2[0:0] == 1'b1) ? 9'd1 : add_ln281_fu_331_p2);
...
assign tmp_fu_327_p1 = in0_V_TDATA_int_regslice[0:0];

assign x_2_fu_281_p2 = (select_ln279_fu_209_p3 + 3'd1);

assign xor_ln279_fu_255_p2 = (icmp_ln280_fu_203_p2 ^ 1'd1);

endmodule //FMPadding_Batch_6
