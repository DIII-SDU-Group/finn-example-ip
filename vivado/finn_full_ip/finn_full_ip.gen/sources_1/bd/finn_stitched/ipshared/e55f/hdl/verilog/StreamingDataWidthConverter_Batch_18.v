...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_18_StreamingDataWidthConverter_Batch_18,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.839000,HLS_SYN_LAT=4099,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1076,HLS_SYN_LUT=265,HLS_VERSION=2020_2}" *)

module StreamingDataWidthConverter_Batch_18 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
StreamingDataWidthConverter_Batch_18_regslice_both #(
    .DataWidth( 512 ))
...
assign icmp_ln476_fu_115_p2 = ((t_reg_67 == 13'd4096) ? 1'b1 : 1'b0);
...
assign t_1_fu_109_p2 = (t_reg_67 + 13'd1);

assign zext_ln476_fu_147_p1 = ei_V_reg_89;

endmodule //StreamingDataWidthConverter_Batch_18
