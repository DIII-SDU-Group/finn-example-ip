...
(* CORE_GENERATION_INFO="FMPadding_Batch_1_FMPadding_Batch_1,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.223750,HLS_SYN_LAT=1081603,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=69,HLS_SYN_LUT=423,HLS_VERSION=2020_2}" *)
...
reg   [20:0] indvar_flatten19_reg_83;
reg   [7:0] y_reg_94;
reg   [14:0] indvar_flatten_reg_105;
reg   [7:0] x_reg_116;
reg   [6:0] simd_reg_127;
wire   [20:0] add_ln279_fu_149_p2;
...
wire   [7:0] select_ln279_2_fu_273_p3;
wire   [7:0] select_ln280_1_fu_319_p3;
wire   [1:0] tmp_fu_327_p1;
wire   [6:0] simd_1_fu_343_p3;
wire   [14:0] select_ln280_2_fu_357_p3;
...
wire   [7:0] add_ln279_1_fu_217_p2;
...
wire   [7:0] select_ln279_fu_209_p3;
wire   [7:0] x_2_fu_281_p2;
...
wire   [6:0] add_ln281_fu_331_p2;
wire   [14:0] add_ln280_1_fu_351_p2;
reg   [2:0] ap_NS_fsm;
...
assign add_ln279_1_fu_217_p2 = (y_reg_94 + 8'd1);

assign add_ln279_fu_149_p2 = (indvar_flatten19_reg_83 + 21'd1);

assign add_ln280_1_fu_351_p2 = (indvar_flatten_reg_105 + 15'd1);

assign add_ln281_fu_331_p2 = (simd_reg_127 + 7'd1);
...
assign cmp3_i_i_fu_155_p2 = ((y_reg_94 == 8'd0) ? 1'b1 : 1'b0);

assign cmp3_i_i_mid1_fu_223_p2 = ((add_ln279_1_fu_217_p2 == 8'd0) ? 1'b1 : 1'b0);

assign cmp4_i_i_fu_161_p2 = ((y_reg_94 > 8'd128) ? 1'b1 : 1'b0);

assign cmp4_i_i_mid1_fu_229_p2 = ((add_ln279_1_fu_217_p2 > 8'd128) ? 1'b1 : 1'b0);

assign cmp5_i_i_fu_173_p2 = ((x_reg_116 == 8'd0) ? 1'b1 : 1'b0);

assign cmp5_i_i_mid1_fu_287_p2 = ((x_2_fu_281_p2 == 8'd0) ? 1'b1 : 1'b0);

assign cmp6_i_i_fu_179_p2 = ((x_reg_116 > 8'd128) ? 1'b1 : 1'b0);

assign cmp6_i_i_mid1_fu_293_p2 = ((x_2_fu_281_p2 > 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln279_fu_197_p2 = ((indvar_flatten19_reg_83 == 21'd1081600) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_203_p2 = ((indvar_flatten_reg_105 == 15'd8320) ? 1'b1 : 1'b0);

assign icmp_ln281_fu_261_p2 = ((simd_reg_127 == 7'd64) ? 1'b1 : 1'b0);
...
assign select_ln279_fu_209_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 8'd0 : x_reg_116);

assign select_ln280_1_fu_319_p3 = ((and_ln279_fu_267_p2[0:0] == 1'b1) ? x_2_fu_281_p2 : select_ln279_fu_209_p3);

assign select_ln280_2_fu_357_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 15'd1 : add_ln280_1_fu_351_p2);

assign select_ln280_fu_311_p3 = ((and_ln279_fu_267_p2[0:0] == 1'b1) ? or_cond_i_i_mid1_fu_305_p2 : or_ln279_fu_249_p2);

assign simd_1_fu_343_p3 = ((or_ln281_fu_337_p2[0:0] == 1'b1) ? 7'd1 : add_ln281_fu_331_p2);
...
assign x_2_fu_281_p2 = (select_ln279_fu_209_p3 + 8'd1);
