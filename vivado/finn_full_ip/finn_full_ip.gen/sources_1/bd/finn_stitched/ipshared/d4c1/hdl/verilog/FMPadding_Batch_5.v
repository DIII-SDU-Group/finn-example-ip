...
(* CORE_GENERATION_INFO="FMPadding_Batch_5_FMPadding_Batch_5,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.665250,HLS_SYN_LAT=25603,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=63,HLS_SYN_LUT=477,HLS_VERSION=2020_2}" *)
...
wire   [1:0] ap_phi_reg_pp0_iter0_outData_1_reg_150;
reg   [1:0] ap_phi_reg_pp0_iter1_outData_1_reg_150;
...
always @ (posedge ap_clk) begin
    if ((((empty_36_fu_320_p2 == 1'd1) & (icmp_ln279_fu_170_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((empty_20_fu_410_p2 == 1'd1) & (empty_36_fu_320_p2 == 1'd0) & (icmp_ln279_fu_170_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ap_phi_reg_pp0_iter1_outData_1_reg_150 <= 2'd0;
...
assign tmp_fu_416_p1 = in0_V_TDATA_int_regslice[1:0];
