...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_23_StreamingDataWidthConverter_Batch_23,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.134000,HLS_SYN_LAT=259,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=58,HLS_SYN_LUT=188,HLS_VERSION=2020_2}" *)

module StreamingDataWidthConverter_Batch_23 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
wire   [6:0] phitmp_cast_fu_154_p3;
...
StreamingDataWidthConverter_Batch_23_regslice_both #(
    .DataWidth( 8 ))
...
assign icmp_ln517_fu_125_p2 = ((i_1_fu_119_p2 == 32'd8) ? 1'b1 : 1'b0);
...
assign tmp_fu_144_p4 = {{r_reg_84[6:1]}};

endmodule //StreamingDataWidthConverter_Batch_23
