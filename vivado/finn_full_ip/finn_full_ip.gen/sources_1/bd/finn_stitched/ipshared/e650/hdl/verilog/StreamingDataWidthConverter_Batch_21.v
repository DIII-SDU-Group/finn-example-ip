...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_21_StreamingDataWidthConverter_Batch_21,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.839000,HLS_SYN_LAT=259,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1066,HLS_SYN_LUT=260,HLS_VERSION=2020_2}" *)
...
reg   [0:0] icmp_ln476_reg_172;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln476_reg_172_pp0_iter1_reg;
reg   [8:0] t_reg_67;
reg   [31:0] o_reg_78;
reg   [503:0] ei_V_reg_89;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln476_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ei_V_reg_89 <= {{ap_phi_mux_ei_V_3_phi_fu_103_p4[511:8]}};
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        ei_V_reg_89 <= 504'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln476_reg_172 <= icmp_ln476_fu_115_p2;
        icmp_ln476_reg_172_pp0_iter1_reg <= icmp_ln476_reg_172;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln476_fu_115_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln479_reg_176 <= icmp_ln479_fu_121_p2;
    end
end
...
always @ (*) begin
    if (((icmp_ln479_reg_176 == 1'd0) & (icmp_ln476_reg_172 == 1'd0))) begin
...
always @ (*) begin
    if ((((icmp_ln476_reg_172_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0)) | ((icmp_ln476_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op19_read_state2 == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((icmp_ln476_reg_172_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)) | ((icmp_ln476_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (out_V_TREADY_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op19_read_state2 == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln476_reg_172_pp0_iter1_reg == 1'd0) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((icmp_ln476_reg_172 == 1'd0) & (out_V_TREADY_int_regslice == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln476_reg_172 == 1'd0) & (out_V_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln476_reg_172 == 1'd0) & (out_V_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_io = ((icmp_ln476_reg_172_pp0_iter1_reg == 1'd0) & (out_V_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter2 = ((icmp_ln476_reg_172_pp0_iter1_reg == 1'd0) & (out_V_TREADY_int_regslice == 1'b0));
end
...
assign out_V_TDATA_int_regslice = ap_phi_mux_ei_V_3_phi_fu_103_p4[7:0];
