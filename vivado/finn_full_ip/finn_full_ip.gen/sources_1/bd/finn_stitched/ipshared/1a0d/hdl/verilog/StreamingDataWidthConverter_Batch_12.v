...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_12_StreamingDataWidthConverter_Batch_12,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.839000,HLS_SYN_LAT=32771,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=567,HLS_SYN_LUT=269,HLS_VERSION=2020_2}" *)
...
reg   [15:0] t_reg_67;
reg   [31:0] o_reg_78;
reg   [253:0] ei_V_reg_89;
wire   [15:0] t_1_fu_109_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln476_reg_176 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ei_V_reg_89 <= {{ap_phi_mux_ei_V_3_phi_fu_103_p4[255:2]}};
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        ei_V_reg_89 <= 254'd0;
    end
end
...
assign icmp_ln476_fu_115_p2 = ((t_reg_67 == 16'd32768) ? 1'b1 : 1'b0);

assign icmp_ln479_fu_121_p2 = ((o_reg_78 == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_133_p2 = ((o_1_fu_127_p2 == 32'd128) ? 1'b1 : 1'b0);
...
assign t_1_fu_109_p2 = (t_reg_67 + 16'd1);
