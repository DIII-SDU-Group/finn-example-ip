...
(* CORE_GENERATION_INFO="FMPadding_Batch_2_FMPadding_Batch_2,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.194750,HLS_SYN_LAT=278787,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=64,HLS_SYN_LUT=409,HLS_VERSION=2020_2}" *)
...
wire   [1:0] tmp_fu_321_p1;
wire   [6:0] simd_1_fu_337_p3;
wire   [13:0] select_ln280_2_fu_351_p3;
wire    ap_CS_fsm_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
wire   [1:0] ap_phi_reg_pp0_iter0_outData_1_reg_132;
reg   [1:0] ap_phi_reg_pp0_iter1_outData_1_reg_132;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_94)) begin
        if (((select_ln280_fu_305_p3 == 1'd1) & (icmp_ln279_fu_191_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_outData_1_reg_132 <= 2'd0;
...
assign tmp_fu_321_p1 = in0_V_TDATA_int_regslice[1:0];
