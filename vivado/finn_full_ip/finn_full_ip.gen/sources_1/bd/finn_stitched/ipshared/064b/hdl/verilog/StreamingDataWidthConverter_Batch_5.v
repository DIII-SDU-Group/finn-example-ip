...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.134000,HLS_SYN_LAT=1048579,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=190,HLS_SYN_LUT=204,HLS_VERSION=2020_2}" *)
...
wire   [125:0] phitmp_cast_fu_156_p3;
...
assign icmp_ln508_fu_108_p2 = ((t_reg_75 == 21'd1048576) ? 1'b1 : 1'b0);
...
assign tmp_fu_146_p4 = {{r_reg_86[125:2]}};
