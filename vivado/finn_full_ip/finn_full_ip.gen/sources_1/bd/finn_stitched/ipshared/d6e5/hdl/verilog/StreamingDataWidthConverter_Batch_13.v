...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_13_StreamingDataWidthConverter_Batch_13,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.134000,HLS_SYN_LAT=294915,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=108,HLS_SYN_LUT=201,HLS_VERSION=2020_2}" *)
...
wire   [45:0] phitmp_cast_fu_156_p3;
...
wire   [47:0] out_V_TDATA_int_regslice;
...
assign icmp_ln508_fu_108_p2 = ((t_reg_75 == 19'd294912) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_127_p2 = ((i_1_fu_121_p2 == 32'd24) ? 1'b1 : 1'b0);
...
assign tmp_fu_146_p4 = {{r_reg_86[45:2]}};
