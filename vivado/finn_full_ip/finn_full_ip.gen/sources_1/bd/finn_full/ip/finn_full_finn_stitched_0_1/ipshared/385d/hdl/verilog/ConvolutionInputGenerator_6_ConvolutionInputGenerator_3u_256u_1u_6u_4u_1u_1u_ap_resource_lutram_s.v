...
module ConvolutionInputGenerator_6_ConvolutionInputGenerator_3u_256u_1u_6u_4u_1u_1u_ap_resource_lutram_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] tmp_4_fu_804_p1;
wire   [1:0] trunc_ln202_fu_897_p1;
wire   [0:0] tmp_3_fu_881_p1;
wire   [2:0] trunc_ln220_1_fu_460_p1;
wire   [2:0] trunc_ln220_fu_456_p1;
wire   [2:0] add_ln220_fu_464_p2;
wire   [10:0] shl_ln_fu_470_p3;
wire   [10:0] trunc_ln197_fu_408_p1;
wire   [10:0] current_line_in_block_fu_478_p2;
...
ConvolutionInputGenerator_6_ConvolutionInputGenerator_3u_256u_1u_6u_4u_1u_1u_ap_resource_lutram_s_inputBubkb #(
    .DataWidth( 1 ),
    .AddressRange( 1536 ),
    .AddressWidth( 11 ))
inputBuf_V_0_U(
...
ConvolutionInputGenerator_6_mux_42_1_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 1 ),
    .din1_WIDTH( 1 ),
...
assign i_1_fu_390_p2 = (i_reg_267 + 16'd1);

assign icmp_ln197_fu_396_p2 = ((i_reg_267 == 16'd41472) ? 1'b1 : 1'b0);

assign icmp_ln199_fu_412_p2 = ((inp_fu_114 < 32'd4608) ? 1'b1 : 1'b0);

assign icmp_ln205_fu_339_p2 = ((grp_fu_327_p2 == 32'd1536) ? 1'b1 : 1'b0);

assign icmp_ln208_fu_921_p2 = ((current_block_write_1_fu_915_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln215_fu_421_p2 = ((counter_internal_block_fu_110 < 32'd9215) ? 1'b1 : 1'b0);

assign icmp_ln224_fu_510_p2 = ((count_simd_1_fu_504_p2 == 32'd256) ? 1'b1 : 1'b0);

assign icmp_ln227_fu_522_p2 = ((k_x_1_fu_516_p2 == 32'd3) ? 1'b1 : 1'b0);

assign icmp_ln230_fu_534_p2 = ((k_y_1_fu_528_p2 == 32'd3) ? 1'b1 : 1'b0);

assign icmp_ln233_fu_546_p2 = ((ofm_x_1_fu_540_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln236_fu_558_p2 = ((ofm_y_1_fu_552_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln245_1_fu_792_p2 = ((read_block_fu_82 < 32'd6) ? 1'b1 : 1'b0);

assign icmp_ln245_fu_786_p2 = ((counter_internal_block_fu_110 < 32'd1535) ? 1'b1 : 1'b0);

assign icmp_ln252_fu_333_p2 = ((grp_fu_327_p2 == 32'd1536) ? 1'b1 : 1'b0);

assign icmp_ln257_fu_829_p2 = ((current_block_write_3_fu_446_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln264_fu_862_p2 = ((counter_internal_block_1_fu_856_p2 == 32'd9215) ? 1'b1 : 1'b0);
...
assign shl_ln_fu_470_p3 = {{add_ln220_fu_464_p2}, {8'd0}};

assign tmp_3_fu_881_p1 = in0_V_TDATA[0:0];

assign tmp_4_fu_804_p1 = in0_V_TDATA[0:0];

assign trunc_ln197_fu_408_p1 = count_simd_fu_102[10:0];
...
assign trunc_ln220_1_fu_460_p1 = ofm_x_fu_90[2:0];

assign trunc_ln220_fu_456_p1 = k_x_fu_98[2:0];
...
endmodule //ConvolutionInputGenerator_6_ConvolutionInputGenerator_3u_256u_1u_6u_4u_1u_1u_ap_resource_lutram_s
