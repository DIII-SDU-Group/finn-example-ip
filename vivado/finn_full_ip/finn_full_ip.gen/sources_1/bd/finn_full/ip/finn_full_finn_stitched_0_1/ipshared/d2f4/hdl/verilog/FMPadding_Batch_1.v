...
(* CORE_GENERATION_INFO="FMPadding_Batch_1_FMPadding_Batch_1,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.222500,HLS_SYN_LAT=540803,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=66,HLS_SYN_LUT=416,HLS_VERSION=2020_2}" *)
...
reg   [19:0] indvar_flatten19_reg_83;
reg   [7:0] y_reg_94;
reg   [13:0] indvar_flatten_reg_105;
reg   [7:0] x_reg_116;
reg   [5:0] simd_reg_127;
wire   [19:0] add_ln279_fu_149_p2;
...
assign add_ln279_fu_149_p2 = (indvar_flatten19_reg_83 + 20'd1);

assign add_ln280_1_fu_351_p2 = (indvar_flatten_reg_105 + 14'd1);

assign add_ln281_fu_331_p2 = (simd_reg_127 + 6'd1);
...
assign icmp_ln279_fu_197_p2 = ((indvar_flatten19_reg_83 == 20'd540800) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_203_p2 = ((indvar_flatten_reg_105 == 14'd4160) ? 1'b1 : 1'b0);

assign icmp_ln281_fu_261_p2 = ((simd_reg_127 == 6'd32) ? 1'b1 : 1'b0);
...
assign simd_1_fu_343_p3 = ((or_ln281_fu_337_p2[0:0] == 1'b1) ? 6'd1 : add_ln281_fu_331_p2);
