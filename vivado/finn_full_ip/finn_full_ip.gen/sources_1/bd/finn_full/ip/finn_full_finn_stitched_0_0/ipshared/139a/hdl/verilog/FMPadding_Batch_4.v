...
(* CORE_GENERATION_INFO="FMPadding_Batch_4_FMPadding_Batch_4,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.248000,HLS_SYN_LAT=41475,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=56,HLS_SYN_LUT=387,HLS_VERSION=2020_2}" *)

module FMPadding_Batch_4 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
reg   [15:0] indvar_flatten19_reg_83;
reg   [4:0] y_reg_94;
reg   [12:0] indvar_flatten_reg_105;
reg   [4:0] x_reg_116;
reg   [7:0] simd_reg_127;
wire   [15:0] add_ln279_fu_149_p2;
...
wire   [4:0] select_ln279_2_fu_273_p3;
wire   [4:0] select_ln280_1_fu_319_p3;
wire   [0:0] tmp_fu_327_p1;
wire   [7:0] simd_1_fu_343_p3;
wire   [12:0] select_ln280_2_fu_357_p3;
...
wire   [4:0] add_ln279_1_fu_217_p2;
...
wire   [4:0] select_ln279_fu_209_p3;
wire   [4:0] x_2_fu_281_p2;
...
wire   [12:0] add_ln280_1_fu_351_p2;
reg   [2:0] ap_NS_fsm;
...
FMPadding_Batch_4_regslice_both #(
    .DataWidth( 8 ))
...
assign add_ln279_1_fu_217_p2 = (y_reg_94 + 5'd1);

assign add_ln279_fu_149_p2 = (indvar_flatten19_reg_83 + 16'd1);

assign add_ln280_1_fu_351_p2 = (indvar_flatten_reg_105 + 13'd1);
...
assign cmp3_i_i_fu_155_p2 = ((y_reg_94 == 5'd0) ? 1'b1 : 1'b0);

assign cmp3_i_i_mid1_fu_223_p2 = ((add_ln279_1_fu_217_p2 == 5'd0) ? 1'b1 : 1'b0);

assign cmp4_i_i_fu_161_p2 = ((y_reg_94 > 5'd16) ? 1'b1 : 1'b0);

assign cmp4_i_i_mid1_fu_229_p2 = ((add_ln279_1_fu_217_p2 > 5'd16) ? 1'b1 : 1'b0);

assign cmp5_i_i_fu_173_p2 = ((x_reg_116 == 5'd0) ? 1'b1 : 1'b0);

assign cmp5_i_i_mid1_fu_287_p2 = ((x_2_fu_281_p2 == 5'd0) ? 1'b1 : 1'b0);

assign cmp6_i_i_fu_179_p2 = ((x_reg_116 > 5'd16) ? 1'b1 : 1'b0);

assign cmp6_i_i_mid1_fu_293_p2 = ((x_2_fu_281_p2 > 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln279_fu_197_p2 = ((indvar_flatten19_reg_83 == 16'd41472) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_203_p2 = ((indvar_flatten_reg_105 == 13'd2304) ? 1'b1 : 1'b0);
...
assign select_ln279_fu_209_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 5'd0 : x_reg_116);

assign select_ln280_1_fu_319_p3 = ((and_ln279_fu_267_p2[0:0] == 1'b1) ? x_2_fu_281_p2 : select_ln279_fu_209_p3);

assign select_ln280_2_fu_357_p3 = ((icmp_ln280_fu_203_p2[0:0] == 1'b1) ? 13'd1 : add_ln280_1_fu_351_p2);
...
assign x_2_fu_281_p2 = (select_ln279_fu_209_p3 + 5'd1);

assign xor_ln279_fu_255_p2 = (icmp_ln280_fu_203_p2 ^ 1'd1);

endmodule //FMPadding_Batch_4
