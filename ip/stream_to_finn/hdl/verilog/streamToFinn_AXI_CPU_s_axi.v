...
// ==============================================================
`timescale 1ns/1ps
module streamToFinn_AXI_CPU_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER           = 14'h0008,
    ADDR_ISR           = 14'h000c,
    ADDR_IMAGE_IN_BASE = 14'h2000,
    ADDR_IMAGE_IN_HIGH = 14'h3fff,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
//------------------------Instantiation------------------
// int_image_in
streamToFinn_AXI_CPU_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 1536 )
) int_image_in (
    .clk0     ( ACLK ),
...
assign RVALID  = (rstate == RDDATA) & !int_image_in_read;
...
module streamToFinn_AXI_CPU_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
